...
class GenericController extends Controller
{
    ...
    public function cms_generator(Request $request)
    {
        ...
        $post_feilds = array_diff_key($_POST , $token_ignore);
        try {
            $cms = cms::where("slug",$_POST['slug'])->first();
            if ($cms) {
                $create = cms::where("slug" , $_POST['slug'])->update($post_feilds);
                $msg = "Record has been updated";
            }
            else{
                $create = cms::create($post_feilds);
                $msg = "Record has been updated";
            }
                        ...
                        <div class="modal-dialog text-left">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button id="discard" class="btn btn-primary" data-dismiss="modal">Close</button>
