...
<div class="sidebar">
            <div class="site-width">
                ...
                <ul id="side-menu" class="sidebar-menu">
                    ...
                    @if(Auth::user()->role_id == 11 || Auth::user()->role_id == 36)
                    <li class="dropdown"><a href="#"><i class="icon-organization mr-1"></i> Tools</a>
                        <ul>
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Reports</a>
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{route('registered_user_report')}}"><i class="icon-energy"></i> Manage User</a>
                                    </li>

                                    <li>
                                        <a href="{{route('inquiry_manage')}}"><i class="icon-energy"></i> Manage Inquiry</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-layers mr-1"></i> Web Apps</a>
                        <ul>
                            ...
                            @if(Auth::user()->role_id == 1)
                                <li><a href="{{route('registered_user_report')}}"><i class="icon-energy"></i> Manage User</a></li>
                                <li><a href="{{route('manage_category')}}"><i class="icon-energy"></i> Manage Category</a></li>
                                <li><a href="{{route('manage_product')}}"><i class="icon-energy"></i> Manage Product</a></li>
                                <li><a href="{{route('manage_book')}}"><i class="icon-energy"></i> Manage book</a></li>
                                <li><a href="{{route('manage_orders')}}"><i class="icon-energy"></i> Manage Order</a></li>
                                <li><a href="{{route('manage_banner')}}"><i class="icon-energy"></i> Manage Banner</a></li>
                                <li><a href="{{route('manage_blog')}}"><i class="icon-energy"></i> Manage Blog</a></li>
                                <li><a href="{{route('manage_blog_comment')}}"><i class="icon-energy"></i> Manage Blog Comment</a></li>
                            @endif
                            @if(Auth::user()->role_id != 1)
                                <li><a href="{{route('purchased_product')}}"><i class="icon-energy"></i> Purchased Product</a></li>
                            @endif

                            @if(Auth::user()->role_id == 11 || Auth::user()->role_id == 36)
                                <li><a href="{{route('candidate_form')}}"><i class="icon-tag"></i> Add Candidate</a></li>
                                 <li><a href="{{route('step2_form')}}"><i class="icon-tag"></i> Create Job</a></li>
