...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        ...
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="javascript:void(0)"> Blogs Listing Dashboard</a></li>
            </ul>
        </div>
            --}}
            ...
            <div class="container-fluid site-width">
                ...
                <div class="row">
                    <div class="col-12 align-self-center">
                        <div class="sub-header py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto pl-2"><span class="h4 my-auto">Blog Listing</span></div>
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                                <li class="breadcrumb-item active"><a href="{{route('blogs_index')}}">Blogs</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right text-right p-2">
                            <a class="btn btn-success" href="" data-toggle="modal" data-target="#AddModal" style="background: #28a745; border-color: #28a745;"> Create New Blog</a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ $blog->name }}</td>
                        <td>{{ $blog->post_by }}</td>
                        <td><div><input data-id="{{$blog->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $blog->is_active ? 'checked' : '' }}></div></td>
                        <td>
                            <form action="{{ route('blogs_destroy',$blog->id) }}" method="DELETE" class="form-delete">
                                <a class="btn btn-info showModalBtn" href="#" data-toggle="modal" data-showid="{!! $blog->id !!}">Show</a>
                                <a class="btn btn-primary editModalBtn" href="#" data-toggle="modal" data-id="{!! $blog->id !!}">Edit</a>
                                @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: var(--info); color: #fff;">
                <h5 class="modal-title" id="exampleModalLongTitleshow">Show Blog</h5>
                <button type="button" class="close" style="color: #fff;" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                <strong>Image:</strong>
                                <br />
                                <img src="{{asset('images/no-img-avalible.png')}}" width="100%" id="showImg" alt="blog" />
                            </div>
                            <div class="form-group">
                                <strong>Post By:</strong>
                    ...
                    <form action="{{ route('blogs_update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <strong>Image:</strong>
                                <br />
                                <img src="{{asset('images/no-img-avalible.png')}}" width="100%" id="editImg" alt="blog" />
                                <input type="file" name="img" value="{{ old('img') }}" id="img" class="form-control mt-2 mb-2" />
                                <br />
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".showModalBtn").click(function () {
            ...
            var action = '{{route("blogs_show")}}/' + id;
            var url = '{{route("blogs_show")}}/' + id;
            $.ajax({
                type: "get",
                url: url,
                data: { id: id },
                success: function (data) {
                    ...
                    // blog.play();
                    $("#showid").attr("action", '{{route("blogs_show")}}/' + id);
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".editModalBtn").click(function () {
            var id = $(this).data("id");
            var action = '{{route("blogs_edit")}}/' + id;
            var url = '{{route("blogs_edit")}}/' + id;
            $.ajax({
                type: "get",
                url: url,
                data: { id: id },
                success: function (data) {
                    ...
                    // blog.appendChild(source);
                    // blog.play();
                    // $('#editid').attr('action', '{{route("blogs_update")}}/'+id);
