                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" readonly="" disabled="" name="username" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" value="{{$user->username}}" required>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationCustomUsername">Personal Email</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                            </div>
                                                            <input type="email" class="form-control" name="personal_email" id="validationCustomUsername" placeholder="Personal Email" aria-describedby="inputGroupPrepend" value="{{$user->personal_email}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="tel" class="form-control" name="emergency_number" data-inputmask="'mask': '0399-99999999'" id="validationCustomUsername" placeholder="Emergency Number" aria-describedby="inputGroupPrepend" value="{{$user->emergency_number}}" required>
                                                            <div class="invalid-feedback">
