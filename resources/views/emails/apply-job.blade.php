...
<html lang="en">
   ...
   <head>
      ...
      <title>The Education Team | Apply Job</title>
                  ...
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td align="center" valign="top" background="{{asset('web/images/background-image-newletter-2.jpg')}}" bgcolor="#66809b" style="background-size:cover; background-position:top; background-size: cover;

    background-repeat: no-repeat;">

                           <table class="col-600" width="600" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
                             @if($details['user']->role_type =='Employee')
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td align="center" style="font-family: 'Lato', sans-serif; font-size:15px; color:#ffffff; line-height:24px; font-weight: 300;">
                                       ...
                                       Inquiry has been successfully submitted <br>we will contact you shortly .
                              ...
                              @endif
                   @if($details['user']->role_type =='Employer')
                               <tbody>
                  ...
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">Applied Job Detail</td>
                        ...
                        <tr>
                           ...
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              <p>Job Title: <b><?=$details['job_title']?></b></p>

                              <p>employment_type : <b><?=$details['employment_type']?></b></p>

                              <p>role_location  : <b><?=$details['role_location']?></b></p>
                              <p>User  Name : <b><?=$details['first_name']?></b></p>
