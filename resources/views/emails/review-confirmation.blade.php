...
<html lang="en">
   ...
   <head>
      ...
      <title>The Education Team | Review Form</title>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td align="center" style="font-family: 'Lato', sans-serif; font-size:15px; color:#ffffff; line-height:24px; font-weight: 300;">
                                       ...
                                       Review form has been successfully submitted <br>Quick Review.
                  ...
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">Review FORM</td>
                        ...
                        <tr>
                           ...
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              <p>Company : <b><?=$details['company_name']?> </b></p>

                              <p>Summary : <b><?=$details['review_summary']?> </b></p>

                              <p>Review: <b><?=$details['your_review']?></b></p>

                              <p>Pros	 : <b><?=$details['pros']?> </b></p>

                              <p>Cons : <b><?=$details['cons']?></b></p>

                              <a href="<?=$details['redirect_link']?>" target="_blank" >Verify Review</a>
