                    ...
                    <tr>
                        <td style="padding:0;">
                            <p style="font-size: 25px;color: #2d2d2f;"><a href="#"
                                    style="color: #0066cc;font-weight: bold;">{{ $name }}</a> confirmed you
                                interview</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span
                                style="background-color: #e4f7e6;color: #1f662c;font-size: 14px;padding: 5px 10px;border-radius: 5px;font-weight: bold;">Confirmed</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
