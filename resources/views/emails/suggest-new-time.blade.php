...
<html lang="en">
   ...
   <head>
      ...
      <title>The Education Team | Suggest New Interview Time</title>
                  ...
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">Suggest New Interview Time</td>
                        ...
                        <tr>
                           ...
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              <p>Interview Date  : <b><?=$details['date']?></b></p>

                              <p>Start Time  : <b><?=$details['start_time']?></b></p>

                              <p>End Time : <b><?=$details['end_time']?></b></p>
