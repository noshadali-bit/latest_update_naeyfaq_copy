                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td align="center" style="font-family: 'Lato', sans-serif; font-size:15px; color:#ffffff; line-height:24px; font-weight: 300;">
                                       ...
                                       Employee Apply Job Recently <br>
                                    </td>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              <p>Company Name : <b><?=$admin['company_name']?></b></p>

                              <p>Job Title: <b><?=$admin['job_title']?></b></p>

                              <p>employment_type : <b><?=$admin['employment_type']?></b></p>

                              <p>role_location  : <b><?=$admin['role_location']?></b></p>
                              <p>User  Name : <b><?=$admin['first_name']?></b></p>
